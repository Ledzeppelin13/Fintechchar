...
บรรทัดที่ 78-80  เป็นfunction ```For loop``` ซึ่งนำเอาข้อมูลเด็กทั้ง 16 จากบล็อกเชนมาเชื่อมต่อกับ back end คือ app.js  แปลความได้ว่า **เมื่อมีผู้อุปการะแล้วให้เปลี่ยนปุ่ม "รับอุปการะ" เป็น "อุปการะแล้ว"** ซึ่งก่อนนะจบ function ```markAdopted``` ให้ย้อนไปทำ function  ```bindEvents``` ในบรรทัดที่ 63 ก่อน 

[![appjs4.png](https://i.postimg.cc/RFmf2Xyk/appjs4.png)](https://postimg.cc/06tbwd8n)

จาก function  ```bindEvents``` ในบรรทัดที่ 63 เป็นการสั่งว่า เมื่อมีการคลิกที่ ```btn-adopt``` ซึ่งก็คือปุ่ม **"รับอุปการะ"** ให้ไปทำ function  ```handleAdopt ``` ในบรรทัดที่ 88  
...
บรรทัดที่ 106-108 เป็นการให้ ```adoptionInstance``` ซึ่งตอนนี้มีค่าเท่ากับ ```Adoption.sol``` อ่านค่า function ```adopt``` ตามด้วย ```kidId``` ตามด้วย ```account``` จะได้ค่า ```kidId``` ออกมา ให้นำไปไว้ใน function ```result```  จากนั้นให้วนไปทำ function ```markAdopted``` ในบรรทัดที่ 70-84 ตามที่ได้กล่าวมาแล้ว  
